...
describe Dbox do
  ...
  describe '#push' do
    ...
    it 'should handle conflicting pushes of new files gracefully' do
      ...
      make_file "#{@alternate}/hello.txt"
      expect(Dbox.push(@alternate)).to eql(created: [], deleted: [], updated: ['hello.txt'], failed: [], moved: [])
    end
    ...
    it 'should handle conflicting pushes of updated files gracefully' do
      ...
      expect(res[:updated]).to eql(['hello.txt'])
      expect(res[:deleted]).to eql([])
      expect(res[:failed]).to eql([])
    end
  ...
  describe '#sync' do
    ...
    it 'should be able to sync basic changes' do
      ...
      expect(Dbox.sync(@local)).to eql(pull: { created: [], deleted: [], updated: [], failed: [], moved: [] },
                                       push: { created: [], deleted: [], updated: [], failed: [], moved: [] })
      expect(Dbox.sync(@alternate)).to eql(pull: { created: [], deleted: [], updated: [], failed: [], moved: [] },
                                           push: { created: [], deleted: [], updated: [], failed: [], moved: [] })

      make_file "#{@local}/hello.txt"
      expect(Dbox.sync(@local)).to eql(pull: { created: [], deleted: [], updated: [], failed: [], moved: [] },
                                       push: { created: ['hello.txt'], deleted: [], updated: [], failed: [], moved: [] })
      expect(Dbox.sync(@alternate)).to eql(pull: { created: ['hello.txt'], deleted: [], updated: [], failed: [], moved: [] },
                                           push: { created: [], deleted: [], updated: [], failed: [], moved: [] })
    end
    ...
    it 'should be able to sync complex changes' do
      ...
      expect(Dbox.sync(@local)).to eql(pull: { created: [], deleted: [], updated: [], failed: [], moved: [] },
                                       push: { created: ['goodbye.txt', 'hello.txt', 'so_long.txt'], deleted: [], updated: [], failed: [], moved: [] })
      expect(Dbox.sync(@alternate)).to eql(pull: { created: ['goodbye.txt', 'hello.txt', 'so_long.txt'], deleted: [], updated: [], failed: [], moved: []},
                                           push: { created: ['farewell.txt', 'hello (1).txt'], deleted: [], updated: [], failed: [], moved: [] })

      make_file "#{@alternate}/farewell.txt"
      make_file "#{@alternate}/goodbye.txt"
      make_file "#{@alternate}/au_revoir.txt"
      expect(Dbox.sync(@alternate)).to eql(pull: { created: [], deleted: [], updated: [], failed: [], moved: [] },
                                           push: { created: ['au_revoir.txt'], deleted: [], updated: ['farewell.txt', 'goodbye.txt'], failed: [], moved: [] })
      expect(Dbox.sync(@local)).to eql(pull: { created: ['au_revoir.txt', 'farewell.txt', 'hello (1).txt'], deleted: [], updated: ['goodbye.txt'], failed: [], moved: [] },
                                       push: { created: [], deleted: [], updated: [], failed: [], moved: [] })
    end
